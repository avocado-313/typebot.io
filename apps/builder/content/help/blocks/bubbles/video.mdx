...
When you paste a video URL, Azeer will automatically detect the video service and parse it with the proper iframe settings. It currently works with:
...
Feel free to suggest a missing service to support.
