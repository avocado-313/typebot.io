---
title: Link to another bot
icon: box
---

This logic block allows you to go into another bot's flow. This ultimately helps keep your flows clean and be able to reuse a flow in multiple places.

<Frame>
  <img
    src="/images/blocks/logic/link.png"
    alt="Link to another bot logic block"
  />
</Frame>
